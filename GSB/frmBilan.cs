...
namespace GSB
{
    public partial class frmBilan : FrmBase
    {
        ...
        #region procédures événementielle
        ...
        private void dgvEchantillons_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == 1)
            {
                suppressionEchantillon(e.RowIndex);
            }
        }
